...
from Model.ExperienciaVM import ExperienciaVM
...
class ScraperDatos:
    ...
    def CampoSimple(self):
        ...
        for item in experience_items:
            ...
            experiencia = ExperienciaVM(empresa, puesto, "", duracion, inicio, fin)
            experiencias.append(experiencia)
                
        return experiencias # Aqui se devolveria el objeto deseado
