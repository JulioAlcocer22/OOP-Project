...
class Configuracion:
	...
	def iniciarSesion(self):
		...
		self.driver.get('https://www.linkedin.com/home') #Se dirige a la página principal de LinkedIn
	...
	def lenguajePaginaWebEsEspañol(self):
		body_content = self.driver.find_element_by_tag_name('body').text

		if "español" in body_content.lower() or "spanish" in body_content.lower() or "es" in body_content.lower() :
		    #print("La página web está en español.")
		    return True
		else:
		    #print("La página web no está en español.")
		    return False
